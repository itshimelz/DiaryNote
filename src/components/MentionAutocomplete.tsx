...
export const MentionAutocomplete: React.FC<MentionAutocompleteProps> = ({
  ...
  return (
    <div
      ...
      className={`absolute z-50 w-64 max-w-[calc(100%-2rem)] border rounded-xl shadow-xl overflow-hidden py-1 text-xs backdrop-blur-md transition-all select-none ${themeConfig.headerBg} ${themeConfig.border} ${themeConfig.text}`}
    >
      <div
